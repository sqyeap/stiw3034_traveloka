...
public class TC_14_searchFlightHotel_Valid {
	...
	//send input to the origin search bar
		...
		driver.findElement(By.xpath("//*[@id=\"__next\"]/div[3]/div[2]/div[1]/div[2]/div/div[3]/div/div/div/div/div[1]/div/div[1]/div[1]/div[2]/div/div/div/div/div[2]/div/div/div/div/div[2]/span/span[1]")).click();
		...
		driver.findElement(By.xpath("//input[@placeholder = \"City, hotel, place to go\"]")).sendKeys("Bangkok");
		...
		//Check for the flight result
		String ActualTitle = driver.findElement(By.xpath("//*[@id=\"desktopContentV3\"]/div/div[4]/div[2]/div[3]/div[1]/div[1]/span[1]")).getText();
		String ExpectedTitle = "Our recommendation";
