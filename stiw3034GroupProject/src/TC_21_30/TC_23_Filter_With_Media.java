...
/**
 * Test Case for Traveloka - Filter Reviews with Media or Picture(s)
 * 
 * @author Yeap
 *
 */

public class TC_23_Filter_With_Media {
	
	/**
	 * Test Case for Browse Hotel Reviews with Media or Picture(s)
	 */
	...
	public void TC23() throws InterruptedException {
		...
		// Get picture
		WebElement BannerImageElement = driver.findElement(By.xpath("//*[@id=\"__next\"]/div/div[5]/div[13]/div/div[3]/div[3]/div/div[1]/div/div[2]/div[3]/div[1]/div/div/img"));
