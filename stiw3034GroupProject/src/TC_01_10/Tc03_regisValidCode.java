...
public class Tc03_regisValidCode {
	// test registration valid code
	@Rule
	...
	public void Tc03() throws InterruptedException {
		...
		try {
			...
			WebElement buttonSubmit = ggl.findElement(By.xpath(
					"//*[@id=\"__next\"]/div[4]/div[2]/div/div[3]/div[1]/div[2]/div/div[1]/div[2]/div/div[2]/div"));
			buttonSubmit.click();
			Thread.sleep(1000);
