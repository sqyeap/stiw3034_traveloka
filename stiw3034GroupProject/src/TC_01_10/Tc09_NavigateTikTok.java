...
public class Tc09_NavigateTikTok {
	@Rule
	...
	public void Tc09() throws InterruptedException {
		...
		// Locate the "Follow us on Tiktok" button using XPath
		WebElement followInsButton = ggl
				.findElement(By.xpath("//*[@id=\"__next\"]/div[6]/div/div[1]/div[2]/div[1]/div[2]/ul/li[5]/a"));
		...
		// Now you are on the Tiktok page. Get the current URL
		...
		try {
			Assert.assertEquals("https://www.tiktok.com/@traveloka.my", currentUrl);// Valid expected URL
